...
export default function ArticleForm() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-surface-container-low text-on-surface flex items-center justify-center">
        <div className="text-center">
          <div className="inline-block w-8 h-8 border-4 border-primary border-t-transparent rounded-full animate-spin mb-4"></div>
          <p className="text-secondary font-body">Carregando artigo...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-surface-container-low text-on-surface">
      <div className="max-w-3xl mx-auto px-4 py-8 md:py-12">
        <Link
          to="/dashboard"
          className="inline-flex items-center gap-2 text-secondary hover:text-on-surface transition-colors mb-6 font-medium"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
           ...
           <div>
             ...
             />
             <div className="mt-1 text-right text-sm text-secondary font-body">
           ...
           <div>
             ...
             <div className="relative">
               ...
               <label
                 htmlFor="image"
                 className="flex items-center justify-center gap-2 w-full px-4 py-8 border border-dashed border-outline-variant rounded-xl text-secondary bg-surface hover:text-on-surface hover:border-primary cursor-pointer transition-colors"
               >
             ...
             {(image || existingImageUrl) && (
               <div className="mt-4 rounded-xl overflow-hidden border border-outline-variant bg-surface p-2">
                 <img 
                   ...
                   onError={(e) => {
                     ...
                     e.currentTarget.parentElement!.innerHTML = '<div class="w-full h-[240px] md:h-[320px] flex items-center justify-center text-primary/20 bg-surface-container rounded-lg"><span class="material-symbols-outlined text-6xl">image</span></div>';
                   }}
                 />
               </div>
             )}
          ...
          <div>
                 ...
                 {tags.map((tag) => (
                   ...
                   >
                     ...
                     <button
                       ...
                       className="hover:text-error transition-colors opacity-70 hover:opacity-100"
                     >
           ...
           <div>
             ...
             />
             <div className="mt-2 text-sm text-secondary font-body flex justify-between">
